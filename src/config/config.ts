 ...
 * @returns The configured settings, or null if any required setting is not found.
 */
export const getExistingConfig = (): ChatConfig | null => {
  ...
  // Return null if any required settings are missing
 ...
 */
export const promptUserForConfig = async (): Promise<ChatConfig | null> => {
...
/**
 * Main function to ensure valid configuration exists
 */
export const ensureValidConfig = async (): Promise<ChatConfig | null> => {
  let config = getExistingConfig();
